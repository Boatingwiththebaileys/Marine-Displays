...
void handle_gauges_page() {
    ...
    html += "  if(!sel) return;\n";
    html += "  var divIds=['gaugeconfig','numberconfig','dualconfig','quadconfig','gaugenumconfig','graphconfig','compassconfig','positionconfig','aisconfig','attitudeconfig'];\n";
    html += "  var typeMap={'0':['gaugeconfig'],'1':['numberconfig'],'2':['dualconfig'],'3':['quadconfig'],'4':['gaugeconfig','gaugenumconfig'],'5':['graphconfig'],'6':['compassconfig'],'7':['positionconfig'],'8':['aisconfig'],'9':['attitudeconfig']};\n";
    ...
    // Hide entire Background dropdown for AIS/Attitude (has its own colour picker / no bg)
    html += "    var isAIS=(sel.value==='8');\n";
    html += "    var isATT=(sel.value==='9');\n";
    html += "    bgSel.parentElement.parentElement.style.display=(isAIS||isATT)?'none':'block';\n";
    html += "  }\n";
...
void handle_gauges_screen() {
    ...
    const char* dtNames[] = {"Gauge","Number","Dual","Quad","Gauge + Number","Graph","Compass","Position","AIS","Attitude"};
